...
1. **Open two browser windows**:
   - Window 1: Mangaka (oda@mangaworkflow.com)
   - Window 2: Assistant (asst1@mangaworkflow.com)
2. **SignalR Test**:
...
1. **Login as Admin** (`admin@mangaworkflow.com`) and navigate to `Admin -> Background Jobs`.
